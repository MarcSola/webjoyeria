			...
			<div class="paginacion2">
					...
					<?php
						if( mysql_num_rows($result2) > 9){
							...
							if(isset($_GET['pag'])){
								...
								if ($_GET['pag'] != 1){
									?><a href="../es/relojes_sector.php?pag=<?php echo $_GET['pag']-1 . $tipo_url ?>"><div class="cuadrito"><</div></a><?php
								}

								while( $min_page <= $max_page ){
									?> <a href="../es/relojes_sector.php?pag=<?php echo $min_page . $tipo_url ?>"> <div class="cuadrito"><b> <?php echo $min_page; ?> </b></div></a> <?php
									$min_page += 1;
								}
							...
							$x = 1;
							while( $x <= $tot_paginas ){
								?> <a href="../es/relojes_sector.php?pag=<?php echo $x . $tipo_url ?>"><div class="cuadrito"><b> <?php echo $x; ?> </b></div></a> <?php
								$x += 1;
							}

							?><a href="../es/relojes_sector.php?pag=2"><div class="cuadrito">></div></a><?php
				...
				<?php
					if(isset($_GET['pag'])){ ?>
						...
						<a href="../es/relojes_sector.php?pag=1"><div class="tipo">Todos</div></a>
						<a href="../es/relojes_sector.php?pag=1"><div class="tipo">Mujer</div></a>
						<a href="../es/relojes_sector.php?pag=1"><div class="tipo">Hombre</div></a>

					<?php }else{ ?>

						<a href="../es/relojes_sector.php"><div class="tipo">Todos</div></a>
						<a href="../es/relojes_sector.php<?php echo "?tipo=mujer" ?>"><div class="tipo">Mujer</div></a>
						<a href="../es/relojes_sector.php<?php echo "?tipo=hombre" ?>"><div class="tipo">Hombre</div></a>
