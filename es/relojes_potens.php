...
<body>
	...
	<div id="cuerpo">
		<div id="zona_trabajo_body">
			...
			Industrial Martí de Relojería, S.L. fabricante de Relojes Potens, es una empresa familiar relojera fundada en 1954, experta en servicios plenos para los relojeros. En sus inicios se especializó en la restauración de relojes de bolsillo, adaptándolos para su uso en la muñeca.
			<br><br>
			Después fabricó partes de relojes, cajas, biseles, cristales, correas en sus propios talleres.
			Más tarde se puso en marcha el departamento de fornituras, las piezas de recambio para los movimientos de los relojes, también en herramientas y maquinaria para la industria relojera.
			<br><br>
			El paso de la relojería mecánica a la relojera de cuarzo, lejos de ser un problema, sirvió para afianzarse en el mercado. Se inició la fabricación de equipos de diagnóstico para relojes de cuarzo y se empezó a impartir cursos de reparación de relojes y conferencias técnicas.
			Los relojes Potens se producen con movimientos mecánicos y de cuarzo y su precio está posicionado en el sector medio del mercado.
			<br>
			<br>
			Web oficial de Potens:   <a style="color:white; background-color:rgb(164, 20, 20); padding-left: 3px; padding-right: 3px; border-radius: 5px;
			...
			<div class="paginacion2">
					...
					<?php
						if( mysql_num_rows($result2) > 9){
							...
							if(isset($_GET['pag'])){
								...
								if ($_GET['pag'] != 1){
									?><a href="../es/relojes_potens.php?pag=<?php echo $_GET['pag']-1 . $tipo_url ?>"><div class="cuadrito"><</div></a><?php
								}

								while( $min_page <= $max_page ){
									?> <a href="../es/relojes_potens.php?pag=<?php echo $min_page . $tipo_url ?>"> <div class="cuadrito"><b> <?php echo $min_page; ?> </b></div></a> <?php
									$min_page += 1;
								}
							...
							$x = 1;
							while( $x <= $tot_paginas ){
								?> <a href="../es/relojes_potens.php?pag=<?php echo $x . $tipo_url ?>"><div class="cuadrito"><b> <?php echo $x; ?> </b></div></a> <?php
								$x += 1;
							}

							?><a href="../es/relojes_potens.php?pag=2"><div class="cuadrito">></div></a><?php
				...
				<?php
					if(isset($_GET['pag'])){ ?>
						...
						<a href="../es/relojes_potens.php?pag=1"><div class="tipo">Todos</div></a>
						<a href="../es/relojes_potens.php?pag=1&tipo=mujer"><div class="tipo">Mujer</div></a>
						<a href="../es/relojes_potens.php?pag=1&tipo=hombre"><div class="tipo">Hombre</div></a>

					<?php }else{ ?>

						<a href="../es/relojes_potens.php"><div class="tipo">Todos</div></a>
						<a href="../es/relojes_potens.php<?php echo "?tipo=mujer" ?>"><div class="tipo">Mujer</div></a>
						<a href="../es/relojes_potens.php<?php echo "?tipo=hombre" ?>"><div class="tipo">Hombre</div></a>
