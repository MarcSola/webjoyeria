		...
		<div id="cuerpo">
			<div id="zona_trabajo_body">
				...
				<div id="mitad_izquierda">
					...
					<div class="titulo_fotos_colores" style="width:35%;"> More photos </div>
					...
					<div class="titulo_fotos_colores titulo_fotos_colores_2"> Colours </div>
							    ...
							    if(mysql_num_rows($result_2) > 0){
								    while($row_2 = mysql_fetch_array($result_2)){ ?>
								    	...
								    	<?php }else{ ?>
								    		...
								    		<a href="../en/producto_reloj.php?id=<?php echo $row_2['id_producto'] . '&color='. $row_2['color'] ?>">
				...
				<div id="mitad_derecha">
					...
					<div class= "div_padre_caracteristicas">
						...
						<div class="div_hijo_caracteristicas_i"> Description</div>
						<div style="clear: both;"></div>	
					</div>
					...
					<div class= "div_padre_caracteristicas">
						...
						<div class="div_hijo_caracteristicas_i">Type</div>
						<div style="clear: both;"></div>
					</div>
					...
					<div class= "div_padre_caracteristicas">
						...
						<div class="div_hijo_caracteristicas_i"> Measurements</div>
						<div style="clear: both;"></div>
					</div>
					...
					<div class= "div_padre_caracteristicas">
						...
						<div class="div_hijo_caracteristicas_i">Movement</div>
						<div style="clear: both;"></div>
					</div>
					...
					<div class= "div_padre_caracteristicas">
						...
						<div class="div_hijo_caracteristicas_i">Impermeability</div>
						<div style="clear: both;"></div>
					</div>
					...
					<div class= "div_padre_caracteristicas">
						...
						<div class="div_hijo_caracteristicas_i">Case</div>
						<div style="clear: both;"></div>
					</div>
					...
					<div class= "div_padre_caracteristicas">
						...
						<div class="div_hijo_caracteristicas_i">Back</div>
						<div style="clear: both;"></div>
					</div>
					...
					<div class= "div_padre_caracteristicas">
						...
						<div class="div_hijo_caracteristicas_i">Strap</div>
						<div style="clear: both;"></div>
					</div>
					...
					<div class= "div_padre_caracteristicas">
						...
						<div class="div_hijo_caracteristicas_i">Features</div>
						<div style="clear: both;"></div>
					</div>
					<br>
