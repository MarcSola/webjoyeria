					...
					<div id="big_daddy">
						...
						<?php } 
							...
							if($row['anchura_alianza']!=NULL){ ?>
								...
								<div class= "div_padre_caracteristicas">
									...
									<div class="div_hijo_caracteristicas_i"> Anchura alianza (mm)</div>
									<div style="clear: both;"></div>	
								</div>
						<?php } 
						...
						if($row['espesor']!=NULL){ ?>
							...
							<div class= "div_padre_caracteristicas">
								...
								<div class="div_hijo_caracteristicas_i">Espesor</div>
								<div style="clear: both;"></div>
							</div>
						...
						if($row['forma_alianza']!=NULL){ ?>
							...
							<div class= "div_padre_caracteristicas">
								...
								<div class="div_hijo_caracteristicas_i"> Forma de la alianza</div>
								<div style="clear: both;"></div>
							</div>
						...
						if($row['tipo_interior']!=NULL){ ?>
							...
							<div class= "div_padre_caracteristicas">
								...
								<div class="div_hijo_caracteristicas_i">Tipo de interior</div>
								<div style="clear: both;"></div>
							</div>
