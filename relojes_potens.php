			...
			<div class="paginacion2">
				...
				<?php
					if(isset($_GET['pag'])){ ?>
						...
						<a href="relojes_potens.php?pag=1"><div class="tipo">Todos</div></a>
						<a href="relojes_potens.php?pag=1&tipo=mujer"><div class="tipo">Mujer</div></a>
						<a href="relojes_potens.php?pag=1&tipo=hombre"><div class="tipo">Hombre</div></a>

					<?php }else{ ?>

						<a href="relojes_potens.php"><div class="tipo">Todos</div></a>
						<a href="relojes_potens.php<?php echo "?tipo=mujer" ?>"><div class="tipo">Mujer</div></a>
						<a href="relojes_potens.php<?php echo "?tipo=hombre" ?>"><div class="tipo">Hombre</div></a>
