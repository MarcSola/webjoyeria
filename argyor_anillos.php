		...
		<div class="productos">
			...
			<div class="paginacion2">
				...
				<div class="mostrando" style="height:165px">
					...
					<a href="argyor_anillos.php?familia=oro_blanco"><span class="titulo_anillos_3"> ANILLOS DE COMPROMISO DE ORO BLANCO </span></a><br>
					<a href="argyor_anillos.php?familia=oro_rosa"><span class="titulo_anillos_3"> ANILLOS DE COMPROMISO DE ORO ROSA </span></a><br>
					<a href="argyor_anillos.php?familia=oro_amarillo"><span class="titulo_anillos_3"> ANILLOS DE COMPROMISO DE ORO AMARILLO </span></a><br>
					<a href="argyor_anillos.php?familia=solitario"><span class="titulo_anillos_3"> ANILLOS SOLITARIOS </span></a><br>
		    		...
		    		if($result != NULL){
					    if(mysql_num_rows($result) > 0){
						    while($row = mysql_fetch_array($result)){ ?>
						        ...
						        <a href="producto_anillo.php?id=<?php echo $row['super_id'] ?>"><div class="z_trabajo"> 
							        <div class="relojes">
