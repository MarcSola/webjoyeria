	...
	<div id="cuerpo">
		<div id="zona_trabajo_body">
			<div id="div_marcas">
				...
				<a href="../cat/relojes_potens.php"><div id="titulo_potens"></div></a> <!-- <?php echo $ruta ?>/-->
				<a href="../cat/relojes_nowley.php"><div id="titulo_nowley"></div></a>
				<a href="../cat/relojes_citizen.php"><div id="titulo_citizen"></div></a>
				<a href="../cat/relojes_sector.php"><div id="titulo_sector"></div></a>
			...
			<div class="paginacion2">
					...
					<?php
						if( mysql_num_rows($result2) > 9){
							...
							if(isset($_GET['pag'])){
								...
								if ($_GET['pag'] != 1){
									?><a href="../cat/marcas_relojes.php?pag=<?php echo $_GET['pag']-1 . $tipo_url ?>"><div class="cuadrito"><</div></a><?php
								}

								while( $min_page <= $max_page ){
									?> <a href="../cat/marcas_relojes.php?pag=<?php echo $min_page . $tipo_url ?>"> <div class="cuadrito"><b> <?php echo $min_page; ?> </b></div></a> <?php
									$min_page += 1;
								}
							...
							$x = 1;
							while( $x <= $tot_paginas ){
								?> <a href="../cat/marcas_relojes.php?pag=<?php echo $x . $tipo_url ?>"><div class="cuadrito"><b> <?php echo $x; ?> </b></div></a> <?php
								$x += 1;
							}

							?><a href="../cat/marcas_relojes.php?pag=2"><div class="cuadrito">></div></a><?php
				...
				<?php
					if(isset($_GET['pag'])){ ?>
						...
						<a href="../cat/marcas_relojes.php?pag=1"><div class="tipo">Tots</div></a>
						<a href="../cat/marcas_relojes.php?pag=1&tipo=mujer"><div class="tipo">Dona</div></a>
						<a href="../cat/marcas_relojes.php?pag=1&tipo=hombre"><div class="tipo">Home</div></a>

					<?php }else{ ?>

						<a href="../cat/marcas_relojes.php"><div class="tipo">Tots</div></a>
						<a href="../cat/marcas_relojes.php<?php echo "?tipo=mujer" ?>"><div class="tipo">Dona</div></a>
						<a href="../cat/marcas_relojes.php<?php echo "?tipo=hombre" ?>"><div class="tipo">Home</div></a>
