...
<body>
	...
	<div id="cuerpo">
		<div id="zona_trabajo_body">
			...
			Industrial Martí de Relojería, S.L. fabricant de Rellotges Potens, és una empresa familiar de rellotgeria fundada en 1954, experta en serveis plens pels rellotgers. En els seus inicis es va especialitzar en la restauració de rellotges de butxaca, adaptant-los pel seu ús a la munyeca.
			<br><br>
			Després va fabricar parts de rellotges, caixes, bisells, vidres, corretges en els seus propis tallers.
			Més tard es va posar en marxa el departament de fornitures, les peces de recanvi per als moviments dels rellotges, també en eines i maquinaria per a la industria rellotgera.
			<br><br>
			...
			Els rellotges Potens es produeixen amb moviments mecànics i de quars i el seu preu està posicionat en el sector mig del mercat.
			<br>
			<br>
