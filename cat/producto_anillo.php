								...
								<div class= "fotos_colores">
									...
									<?php 	
									    ...
									    while($row_2 = mysql_fetch_array($result_2)){ ?>
									    	...
									    	<a href="../cat/producto_anillo.php?id=<?php $_GET['id'] ?>&photo=<?php echo $row_2['url'] ?>"><div class="foto_color"> <img src="../Photos/joieria/anillos/<?php echo $row_2['url']; ?>"></img></div></a>
					...
					<div id="big_daddy">
						...
						if($row['numero_piedras']!=NULL){ ?>
							...
							<div class= "div_padre_caracteristicas">
								...
								<div class="div_hijo_caracteristicas_i">Número de pedres</div>
								<div style="clear: both;"></div>
							</div>
