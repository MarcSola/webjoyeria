		...
		<div id="cuerpo">
			<div id="zona_trabajo_body">
				...
				<div id="contenido">
					...
					<div id="titulo"> CONTACTE AMB NOSALTRES </div>
					<div id="cuadro_texto">
				    	...
				    	Nom <br> <input type="text"  name="referencia" size="40" maxlength="40"/> <br><br>
				    	Telèfon <br> <input type="text"  name="referencia" size="40" maxlength="40"/> <br><br>
				    	E-mail <br> <input type="text"  name="referencia" size="40" maxlength="40"/> <br><br>
				    	Assumpte <br> <textarea name="comment" rows="25" cols="105" name="descripcion" form="usrform"></textarea><br><br>
