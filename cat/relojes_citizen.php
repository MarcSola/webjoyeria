...
<body>
	...
	<div id="cuerpo">
		<div id="zona_trabajo_body">
			...
			Els nostres 84 anys de primicias mundials inclouen innovacions com rellotges controlats per radio y rellotges amb sincronització de l'hora vía satèl·lit. Una altra creació excepcional va ser el desenvolupament revolucionari de la tecnologia Eco-Drive. CITIZEN va ser el pioner de d'aquesta tecnologa en 1976, molt per davant d'altres fabricants. Utilizant l'electricitat generada a partir de qualsevol font de llum, aquesta innovació extraordinària va canviar per sempre l'origen de l'energia dels rellotges. La tecnologia Eco-Drive va eliminar la necesitat de substituir piles, una avantatge especialment important en moltes zones on és difícil obtenir-les, i va posar el placer de posseir un rellotge CITIZEN a l'avast de moltes més persones, fent l'experiència encara més memorable.
			<br><br>
			Eco-Drive és el nom de la tecnologia exclusiva de CITIZEN que permet a un rellotge funcionar únicament fent servir qualsevol font de llum artificial o natural, gràcies a la electricitat generada per una cèl·lula solar. L'electricitat sobrant s'emmagatzema en una pila recarregable. Aquest mecanisme ha convertit als rellotges que fan servir aquesta tecnologia en els millors amics del medi ambient.
			<br><br>
