...
<head>
    ...
    <link rel="stylesheet"  href="../estilos_css/producto_alianza.css"> 
...
<body>
		...
		<?php 
			...
			if(isset($_GET['id'])){
				...
				$id = "";
				?>
				<script>window.location.replace("argyor_alianzas.php");</script>
				<?php
			    exit;
			}
			...
			<div id="zona_trabajo_body">
				...
				<div id="mitad_izquierda">
					...
					<div id= "imagen_grande">
						...
						<div class="zoom_photo" id ="lupa" >

							<?php 
								if(isset($_GET['photo'])){ ?>

									<img name ="../Photos/joieria/alianzas/<?php echo $_GET['photo'] ?>" src="../Photos/joieria/alianzas/<?php echo $_GET['photo'] ?>" class="zoom_photo">

								<?php }else{ ?>

									<img name ="../Photos/joieria/alianzas/<?php echo $row['url'] ?>" src="../Photos/joieria/alianzas/<?php echo $row['url'] ?>" class="zoom_photo">
					...
					<?php 	
			    		...
			    		if($result_2 != NULL){
						    if(mysql_num_rows($result_2) > 1){ ?>
						    	...
						    	<div class="titulo_fotos_colores"> Més fotos </div>
								...
								<div class= "fotos_colores">
									...
									<?php 	
									    ...
									    while($row_2 = mysql_fetch_array($result_2)){ ?>
									    	...
									    	<a href ="producto_alianza.php?id=<?php echo $_GET['id'] ?>&photo=<?php echo $row_2['url'] ?>"><div class="foto_color"> <img src="../Photos/joieria/alianzas/<?php echo $row_2['url']; ?>"></img></div></a>
				...
				<div id="mitad_derecha">
					...
					<div id="referencia"><b>Referència:</b> 
					<?php 
					...
					<div id="mas_info"> MÉS INFORMACIÓ </div>
					<div id="big_daddy">
						...
						<?php if($row['metal']!=NULL){ ?>
							...
							<div class= "div_padre_caracteristicas">
								...
								<div class="div_hijo_caracteristicas_i"> Metall</div>
								<div style="clear: both;"></div>	
							</div>

						<?php } 
						
							if($row['anchura_alianza']!=NULL){ ?>
								...
								<div class= "div_padre_caracteristicas">
									...
									//echo variable consulta anchura (alianza)

									echo utf8_encode($row['anchura_alianza']);

									?>
									
									</div>
									<div class="div_hijo_caracteristicas_i"> Amplada aliança (mm)</div>
									<div style="clear: both;"></div>	
								</div>
						<?php } 
						...
						if($row['acabado_superficial']!=NULL){ ?>
							...
							<div class= "div_padre_caracteristicas">
								...
								<div class="div_hijo_caracteristicas_i">Acabat superficial</div>
								<div style="clear: both;"></div>
							</div>
						...
						if($row['espesor']!=NULL){ ?>
							...
							<div class= "div_padre_caracteristicas">
								...
								//echo variable consulta espesor(alianza);

								echo utf8_encode($row['espesor']);

								?>
								
								</div>
								<div class="div_hijo_caracteristicas_i">Espessor</div>
								<div style="clear: both;"></div>
							</div>

						<?php }

						if($row['forma_alianza']!=NULL){ ?>
							...
							<div class= "div_padre_caracteristicas">
								...
								//echo variable consulta forma de la alianza;

								echo utf8_encode($row['forma_alianza']);

								?>
								
								</div>
								<div class="div_hijo_caracteristicas_i"> Forma de l'aliança</div>
								<div style="clear: both;"></div>
							</div>
						...
						if($row['forma_piedras']!=NULL){ ?>
							...
							<div class= "div_padre_caracteristicas">
								...
								<div class="div_hijo_caracteristicas_i"> Forma de les pedres</div>
								<div style="clear: both;"></div>
							</div>
						...
						if($row['grupo_productos']!=NULL){ ?>
							...
							<div class= "div_padre_caracteristicas">
								...
								<div class="div_hijo_caracteristicas_i">Grup de productes</div>
								<div style="clear: both;"></div>
							</div>
						...
						if($row['numero_piedras']!=NULL){ ?>
							...
							<div class= "div_padre_caracteristicas">
								...
								<div class="div_hijo_caracteristicas_i">Número de piedres</div>
								<div style="clear: both;"></div>
							</div>
						...
						if($row['peso_diamantes']!=NULL){ ?>
							...
							<div class= "div_padre_caracteristicas">
								...
								<div class="div_hijo_caracteristicas_i">Pes total de diamants</div>
								<div style="clear: both;"></div>
							</div>

						<?php } 

						if($row['tipo_interior']!=NULL){ ?>
							...
							<div class= "div_padre_caracteristicas">
								...
								//echo variable consulta tipo interior (alianza);

								echo utf8_encode($row['tipo_interior']);

								?>
								
								</div>
								<div class="div_hijo_caracteristicas_i">Tipus de interior</div>
								<div style="clear: both;"></div>
							</div>
						...
						if($row['tipo_forma_diamante']!=NULL){ ?>
							...
							<div class= "div_padre_caracteristicas">
								...
								<div class="div_hijo_caracteristicas_i">Tipus/Forma joies amb diamants</div>
								<div style="clear: both;"></div>
							</div>
						...
						if($row['tipo_piedras']!=NULL){ ?>
							...
							<div class= "div_padre_caracteristicas">
								...
								<div class="div_hijo_caracteristicas_i">Tipus de pedres</div>
								<div style="clear: both;"></div>
							</div>
