		...
		<div id="cuerpo">
			<div id="zona_trabajo_body">
				...
				<div id="mitad_izquierda">
					...
					<div class="titulo_fotos_colores titulo_fotos_colores_2"> Colors </div>
							    ...
							    if(mysql_num_rows($result_2) > 0){
								    while($row_2 = mysql_fetch_array($result_2)){ ?>
								    	...
								    	<?php }else{ ?>
								    		...
								    		<a href="../cat/producto_reloj.php?id=<?php echo $row_2['id_producto'] . '&color='. $row_2['color'] ?>">
				...
				<div id="mitad_derecha">
					...
					<div class= "div_padre_caracteristicas">
						...
						<div class="div_hijo_caracteristicas_i"> Descripció</div>
						<div style="clear: both;"></div>	
					</div>
					...
					<div class= "div_padre_caracteristicas">
						...
						<div class="div_hijo_caracteristicas_i">Tipus</div>
						<div style="clear: both;"></div>
					</div>
					...
					<div class= "div_padre_caracteristicas">
						...
						<div class="div_hijo_caracteristicas_i"> Mesures</div>
						<div style="clear: both;"></div>
					</div>
					...
					<div class= "div_padre_caracteristicas">
						...
						<div class="div_hijo_caracteristicas_i">Moviment</div>
						<div style="clear: both;"></div>
					</div>
					...
					<div class= "div_padre_caracteristicas">
						...
						<div class="div_hijo_caracteristicas_i">Impermeabilitat</div>
						<div style="clear: both;"></div>
					</div>
					...
					<div class= "div_padre_caracteristicas">
						...
						<div class="div_hijo_caracteristicas_i">Caixa</div>
						<div style="clear: both;"></div>
					</div>
					...
					<div class= "div_padre_caracteristicas">
						...
						<div class="div_hijo_caracteristicas_i">Fons</div>
						<div style="clear: both;"></div>
					</div>
					...
					<div class= "div_padre_caracteristicas">
						...
						<div class="div_hijo_caracteristicas_i">Corretja</div>
						<div style="clear: both;"></div>
					</div>
					...
					<div class= "div_padre_caracteristicas">
						...
						<div class="div_hijo_caracteristicas_i">Funcions</div>
						<div style="clear: both;"></div>
					</div>
					<br>
