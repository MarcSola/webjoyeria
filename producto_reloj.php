							    ...
							    if(mysql_num_rows($result_2) > 0){
								    while($row_2 = mysql_fetch_array($result_2)){ ?>
								    	...
								    	if($row['nombre_imagen'] == $row_2['nombre_imagen']){ ?>
								    		...
								    		<div class="foto_color"> <img src="http://localhost:8080/WEB/Web_Oliveras/Photos/rellotges/Marques/<?php echo $nombre_marca_inicial['nombre'] ?>/<?php echo $row_2['url'] ?>"></img></div>
								    	
								    	<?php }else{ ?>

								    		<a href="http://localhost:8080/WEB/Web_Oliveras/producto_reloj.php?id=<?php echo $row_2['id_producto'] . '&color='. $row_2['color'] ?>">
