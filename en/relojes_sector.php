...
<body>
	...
	<div id="cuerpo">
		<div id="zona_trabajo_body">
			...
			<b> Sector No Limits was launched in 1973 and has always been closely associated with continuous personal challenges. Its essence is encompassed in 3 keywords:
			SECTOR NO LIMITS - INDESTRUCTIBLE - ITALIAN DESIGN</b>

			<br><br>

			During the eighties and nineties, many athletes successfully completed challenges accompanied by Sector No Limits technical and sport watches, achieving together important and unforgettable performance records, combining pure technology to Italian design. These heroes’ feats entered the public imagination, and Sector No Limits became the expression of technical quality  and the sporting performance of daring men who defy themselves.

			<br><br><br>
			Sector official website:   <a style="color:white; background-color:rgb(164, 20, 20); padding-left: 3px; padding-right: 3px; border-radius: 5px;
			...
			<div class="paginacion2">
					...
					<?php
						if( mysql_num_rows($result2) > 9){
							...
							if(isset($_GET['pag'])){
								...
								if ($_GET['pag'] != 1){
									?><a href="../en/relojes_sector.php?pag=<?php echo $_GET['pag']-1 . $tipo_url ?>"><div class="cuadrito"><</div></a><?php
								}

								while( $min_page <= $max_page ){
									?> <a href="../en/relojes_sector.php?pag=<?php echo $min_page . $tipo_url ?>"> <div class="cuadrito"><b> <?php echo $min_page; ?> </b></div></a> <?php
									$min_page += 1;
								}
							...
							$x = 1;
							while( $x <= $tot_paginas ){
								?> <a href="../en/relojes_sector.php?pag=<?php echo $x . $tipo_url ?>"><div class="cuadrito"><b> <?php echo $x; ?> </b></div></a> <?php
								$x += 1;
							}

							?><a href="../en/relojes_sector.php?pag=2"><div class="cuadrito">></div></a><?php
				...
				<?php
					if(isset($_GET['pag'])){ ?>
						...
						<a href="../en/relojes_sector.php?pag=1"><div class="tipo">All</div></a>
						<a href="../en/relojes_sector.php?pag=1"><div class="tipo">Woman</div></a>
						<a href="../en/relojes_sector.php?pag=1"><div class="tipo">Man</div></a>

					<?php }else{ ?>

						<a href="../en/relojes_sector.php"><div class="tipo">All</div></a>
						<a href="../en/relojes_sector.php<?php echo "?tipo=mujer" ?>"><div class="tipo">Woman</div></a>
						<a href="../en/relojes_sector.php<?php echo "?tipo=hombre" ?>"><div class="tipo">Man</div></a>
