...
<body>
	...
	<div id="cuerpo">
		<div id="zona_trabajo_body">
			...
			Later they started to manufacture watch boxes, calibrated bezels, dials, watch straps, etc. Some years after, they created the supply department: tools and equipments for the watch industry.
			...
			<br><br>
			Nowley official website:   <a style="color:white; background-color:rgb(164, 20, 20); padding-left: 3px; padding-right: 3px; border-radius: 5px;
